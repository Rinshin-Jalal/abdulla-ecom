  ...
  return (
    <section className="py-20 lg:py-40 bg-canvas px-4 lg:px-6 overflow-hidden">
      <motion.div
        ...
        className="container mx-auto bg-white text-ink rounded-[2rem] lg:rounded-[3rem] p-8 lg:p-20 text-center relative overflow-hidden border border-border/60 shadow-sm"
      >
        <motion.div
          animate={{
            scale: [1, 1.15, 1],
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 justify-center items-center">
            <motion.button
              ...
              className="w-full lg:w-auto px-10 lg:px-14 py-4 lg:py-5 bg-accent text-white font-black rounded-full shadow-xl shadow-accent/10 transition-all duration-500 text-sm lg:text-base"
            >
              {t.cta.btn}
            </motion.button>
